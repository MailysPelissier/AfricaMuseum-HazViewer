Vue.createApp({
    ...
    data() {
        ...
        return {
            ...
            size_standard: 10,
            size_duration: [
                { label: '0', min: 0, max: 0, size: 6 },
                { label: '1 - 5', min: 1, max: 5, size: 10 },
                { label: '6 - 10', min: 6, max: 10, size: 14 },
                { label: '> 10', min: 11, max: Infinity, size: 18 },
            ],
            size_casualties: 'median_death',
            size_death: [
                { label: 'No value', min: null, max: null, size: 4 },
                { label: '0 - 9', min: 0, max: 10, size: 7 },
                { label: '10 - 99', min: 10, max: 100, size: 10 },
                { label: '100 - 999', min: 100, max: 1000, size: 13 },
                { label: '> 1000', min: 1000, max: Infinity, size: 16 },
            ],
            size_injured: [
                { label: 'No value', min: null, max: null, size: 4 },
                { label: '0 - 9', min: 0, max: 10, size: 7 },
            ...
            size_articles: [
                ...
                { label: '10 - 99', min: 10, max: 100, size: 10 },
                { label: '100 - 999', min: 100, max: 1000, size: 14 },
                { label: '> 1000', min: 1000, max: Infinity, size: 18 },
            ],
            size_paragraphs: [
                { label: '0 - 9', min: 0, max: 10, size: 6 },
                { label: '10 - 99', min: 10, max: 100, size: 10 },
            ...
            size_languages: [
                { label: '0 - 3', min: 0, max: 3, size: 6 },
                { label: '4 - 6', min: 4, max: 6, size: 10 },
                { label: '7 - 10', min: 7, max: 10, size: 14 },
                { label: '> 10', min: 11, max: Infinity, size: 18 },
            ],
            ...
            size_domains: [
                { label: '0 - 4', min: 0, max: 4, size: 6 },
                { label: '5 - 9', min: 5, max: 9, size: 10 },
                { label: '10 - 20', min: 10, max: 20, size: 14 },
                { label: '> 20', min: 21, max: Infinity, size: 18 },
            ],
            ...
            taille_nb_morts: [
                ...
                { label: '0 - 9', min: 0, max: 10, size: 7 },
                { label: '10 - 99', min: 10, max: 100, size: 10 },
                { label: '≥ 100', min: 100, max: Infinity, size: 13 },
            ],
            taille_nb_blesses: [
                { label: 'No value', min: null, max: null, size: 4 },
                { label: '0 - 9', min: 0, max: 10, size: 7 },
            ...
            min_date_hazminer: "01-01-1800",
            max_date_hazminer: "31-12-2200",
            start_date_hazminer: "01-01-1800",
            end_date_hazminer: "31-12-2200",
            ...
            impact_filter_hazminer: [
                { id: 'median_death', label: 'Median death:', checkbox_null: true, min: 0, max: 150000, min_depart: 0, max_depart: 150000 },
                { id: 'median_injured', label: 'Median injured:', checkbox_null: true, min: 0, max: 1000000000, min_depart: 0, max_depart: 1000000000 },
                { id: 'median_affected', label: 'Median affected:', checkbox_null: true, min: 0, max: 1500000000, min_depart: 0, max_depart: 1500000000 },
            ],
            // Filtre selon la popularité
            popularity_filter: [
                { id: 'n_articles', label: 'Number of articles:', min: 0, max: 30000, min_depart: 0, max_depart: 30000 },
                { id: 'n_paragraphs', label: 'Number of paragraphs:', min: 0, max: 100000, min_depart: 0, max_depart: 100000 },
                { id: 'n_languages', label: 'Number of languages:', min: 0, max: 40, min_depart: 0, max_depart: 40 },
                { id: 'n_source_countries', label: 'Number of source countries:', min: 0, max: 120, min_depart: 0, max_depart: 120 },
                { id: 'n_domains', label: 'Number of domains:', min: 0, max: 4000, min_depart: 0, max_depart: 4000 },
            ],
